...
const STATUS_LABELS: Record<PipelineStatus, string> = {
  [PipelineStatus.NEW_LEAD]: 'New Lead', [PipelineStatus.CONTACTED]: 'Contacted',
  [PipelineStatus.IN_DISCUSSION]: 'In Discussion', [PipelineStatus.PITCHING]: 'Pitching',
  [PipelineStatus.NEGOTIATION]: 'Negotiation', [PipelineStatus.ON_HOLD]: 'On Hold',
  [PipelineStatus.DEAL]: 'Deal', [PipelineStatus.LOST]: 'Lost',
};

interface StatusTransitionProps { currentStatus: PipelineStatus; onStatusChange: (newStatus: PipelineStatus) => void; disabled?: boolean; }
