...
- [x] 1. Setup project structure dan konfigurasi dasar
  - [x] 1.1 Inisialisasi backend project
  ...
  - [x] 1.2 Inisialisasi frontend project
...
- [x] 2. Database schema dan Prisma setup
  - [x] 2.1 Buat Prisma schema dan migrasi
  ...
  - [x] 2.2 Buat seed data untuk Tipe Lead default
...
- [x] 3. Backend core: error handling, validation, dan middleware
  - [x] 3.1 Implementasi custom error classes
  ...
  - [x] 3.2 Implementasi Zod validation schemas
  ...
  - [x] 3.3 Implementasi Auth middleware (JWT)
  ...
  - [x] 3.4 Implementasi RBAC middleware
  ...
  - [x] 3.5 Write property tests untuk RBAC
    - **Property 17: RBAC menolak akses di luar hak role**
    - **Validates: Requirements 11.4**

  - [x] 3.6 Write property tests untuk PIC ownership
...
- [x] 5. Implementasi User Management (CRUD)
  - [x] 5.1 Implementasi User repository dan service
  ...
  - [x] 5.2 Implementasi User routes
  ...
  - [x] 5.3 Write property test untuk soft delete User
    - **Property 3: Soft delete mengubah is_deleted dan mencatat deleted_at**
    - **Validates: Requirements 3.3**

- [x] 6. Implementasi Tipe Lead Management
  - [x] 6.1 Implementasi Tipe Lead repository, service, dan routes
  ...
  - [x] 6.2 Write property test untuk validasi tipe Lead
    - **Property 18: Validasi tipe Lead terhadap master data**
    - **Validates: Requirements 4.3**

- [x] 7. Implementasi Lead Management (CRUD)
  - [x] 7.1 Implementasi Lead repository dan service
  ...
  - [x] 7.2 Implementasi Lead routes
  ...
  - [x] 7.3 Write property tests untuk Lead creation dan uniqueness
    - **Property 1: Lead baru selalu berstatus New Lead**
    - **Property 2: Uniqueness nama_eo bersifat case-insensitive dan trimmed**
    - **Validates: Requirements 1.1, 1.3**

  - [x] 7.4 Write property test untuk soft delete Lead
    - **Property 3: Soft delete mengubah is_deleted dan mencatat deleted_at**
    - **Validates: Requirements 1.4**

  - [x] 7.5 Write property tests untuk filter dan pencarian Lead
    - **Property 15: Filter dan pencarian Lead menggunakan logika AND**
    - **Validates: Requirements 9.1, 9.2, 9.3, 9.4**

- [x] 8. Implementasi Contact Person Management
  - [x] 8.1 Implementasi Contact Person repository, service, dan routes
...
- [x] 10. Implementasi Assignment (Assign/Re-assign PIC)
  - [x] 10.1 Implementasi Assignment repository dan service
  ...
  - [x] 10.2 Implementasi Assignment routes
  ...
  - [x] 10.3 Write property tests untuk Assignment
...
- [x] 11. Implementasi Status Pipeline
  - [x] 11.1 Implementasi Status Pipeline service
  ...
  - [x] 11.2 Implementasi Status Pipeline routes
  ...
  - [x] 11.3 Write property tests untuk Status Pipeline
    - **Property 6: Transisi status pipeline mengikuti aturan ketat**
    - **Property 7: Status tidak dapat diperbarui tanpa Activity**
    - **Validates: Requirements 6.2, 6.3, 6.5**

- [x] 12. Implementasi Activity Log dan Evidence Upload
  - [x] 12.1 Implementasi Activity service
  ...
  - [x] 12.2 Implementasi Evidence upload dengan Multer
  ...
  - [x] 12.3 Implementasi Activity routes
  ...
  - [x] 12.4 Write property tests untuk Activity
  ...
  - [x] 12.5 Write property test untuk file upload
    - **Property 14: Validasi file evidence (format dan ukuran)**
    - **Validates: Requirements 8.1, 8.2**

  - [x] 12.6 Write property test untuk PIC ownership pada Activity
    - **Property 10: PIC baru tidak dapat mengedit Activity PIC sebelumnya**
    - **Validates: Requirements 5.4**

- [x] 13. Implementasi Audit Trail
  - [x] 13.1 Implementasi Audit Trail service
  ...
  - [x] 13.2 Integrasikan Audit Trail ke semua service yang relevan
  ...
  - [x] 13.3 Implementasi Audit Trail routes
  ...
  - [x] 13.4 Write property tests untuk Audit Trail
...
- [x] 14. Wiring backend: register semua routes dan middleware
...
- [x] 15. Checkpoint — Pastikan semua backend tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 16. Frontend: setup dan shared components
  - [x] 16.1 Setup frontend structure dan konfigurasi
  ...
  - [x] 16.2 Implementasi Auth context dan login flow
  ...
  - [x] 16.3 Implementasi layout components
  ...
  - [x] 16.4 Implementasi shared/reusable components
...
- [x] 17. Frontend: halaman Lead Management
  - [x] 17.1 Implementasi Lead list page dengan filter dan search
  ...
  - [x] 17.2 Implementasi Lead form (create/edit)
  ...
  - [x] 17.3 Implementasi Lead detail page
...
- [x] 18. Frontend: halaman Contact Person, Assignment, dan Status
  - [x] 18.1 Implementasi Contact Person components
  ...
  - [x] 18.2 Implementasi Assignment components
  ...
  - [x] 18.3 Implementasi Status Pipeline components
...
- [x] 19. Frontend: halaman Activity dan Evidence
  - [x] 19.1 Implementasi Activity components
  ...
  - [x] 19.2 Implementasi Evidence upload component
...
- [x] 20. Frontend: halaman User Management dan Audit Trail
  - [x] 20.1 Implementasi User Management page
  ...
  - [x] 20.2 Implementasi Audit Trail view
...
- [x] 21. Checkpoint — Pastikan frontend dan backend terintegrasi
  - Ensure all tests pass, ask the user if questions arise.

- [x] 22. Integrasi akhir dan wiring
  - [x] 22.1 Buat Auth endpoints (login/refresh)
...
- [x] 23. Final checkpoint — Pastikan semua tests pass
  - Ensure all tests pass, ask the user if questions arise.
